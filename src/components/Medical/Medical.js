    ...
    <>
      <section className="medicalSection">
        ...
        <section>
          ...
          <p>
            If you bring in a referral from your doctor, we will provide you with a superbill upon request in
          ...
          <p>If you do not bring in a referral, we can still provide you with a superbill, but you have a much higher chance of receiving a reimbursement through your insurance if they accept superbill and have a current referral from them.</p>
        </section>
        ...
        <section>
          ...
          <p>The superbill will be an itemized receipt given to the patient that records out-of-network services done. This is required for submitting to your insurance company for out-of-network providers such as our company. This allows the insurance to reimburse the client directly, not the company.</p>
        </section>
